...
public:
     ...
     /**
      * @brief Gets the configuration struct that has been used to build the XBotInterface
      *
...
private:
     ...
     std::string _urdf_string, _srdf_string, _joint_map_string; // TBD add to copy constr/assign 
