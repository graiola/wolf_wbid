...
// Wrappers (ROS1/ROS2)
#ifdef ROS
  #include <wolf_wbid/ros/cartesian.h>
  #include <wolf_wbid/ros/com.h>
  #include <wolf_wbid/ros/momentum.h>
  #include <wolf_wbid/ros/postural.h>
...
bool IDProblem::buildQP(QPProblem& qp)
{
  ...
  // Postural (slice: limbs only, exclude floating base)
